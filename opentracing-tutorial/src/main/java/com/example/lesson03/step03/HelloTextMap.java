...
public class HelloTextMap {
    private final Tracer tracer;
    private final OkHttpClient client;

    public HelloTextMap(Tracer tracer) {
        this.tracer = tracer;
    ...
    public static void main(String[] args) {
        ...
        new HelloTextMap(tracer).sayHello("Seiya Suzuki");
    }
    ...
    private String getHttp(int port, String path, String param, String value) {
        try {
            ...
            tracer.inject(tracer.activeSpan().context(), Format.Builtin.TEXT_MAP, new HttpHeadersCarrier(requestBuilder));
